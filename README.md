...
questions that you would like to have. As of 12/24/25, it only supports up to 21 questions. Then, it will ask you what the questions should be. After that, it will ask you what the answers to those
questions should be. Then, it will ask you the questions that you entered in a random order. If you get it correct, (if you write the exact same thing that you entered earlier), it will tell you and give you a
